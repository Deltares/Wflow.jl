...
of a new TOML parser that will be a part of Base Julia from version 1.6. See
https://github.com/JuliaLang/julia/pull/36018 for the integration status.

Until we require Julia 1.6, and as long as TOMLX.jl is not a registered package, we will
include a copy of the source code here. This copy is from
https://github.com/KristofferC/TOMLX.jl/commit/4646119c785f529d59c303ad113dc43be46b9c36.
