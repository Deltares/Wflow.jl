const sbm_standard_name_map = Dict{String, ComposedFunction}(
    ...
    "river_water__volume" => @optic(_.routing.river_flow.variables.storage_av),
    ...
    "floodplain_water__volume" =>
        @optic(_.routing.river_flow.floodplain.variables.storage_av),
    ...
    "land_surface_water__volume" =>
        @optic(_.routing.overland_flow.variables.storage_av),
