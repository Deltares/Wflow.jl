...
@testitem "Piave water demand and allocation (sbm model)" begin
    ...
    @testset "First timestep" begin
        ...
        @test mean(river_flow.variables.q_av) ≈ 60.51393332926652
        @test maximum(river_flow.variables.q_av) ≈ 235.61006630473386
    end
    ...
    @testset "Second timestep" begin
        ...
        @test mean(river_flow.variables.q_av) ≈ 56.77301130292208
        @test maximum(river_flow.variables.q_av) ≈ 227.42438424168512
    end
