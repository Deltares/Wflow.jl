@testitem "vertical processes" begin
    ...
    @test Wflow.feddes_h3(-300.0, -600.0, to_SI(3.5, MM_PER_DAY)) ≈ -412.5
    @test Wflow.feddes_h3(-300.0, -600.0, to_SI(0.5, MM_PER_DAY)) == -600.0
    @test Wflow.feddes_h3(-300.0, -600.0, to_SI(6.0, MM_PER_DAY)) == -300.0
