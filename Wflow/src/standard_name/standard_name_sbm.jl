...
const sbm_standard_name_map = OrderedDict{String, ParameterMetadata}(
    ...
    "compacted_soil_surface_water__excess_volume_flux" => ParameterMetadata(;
        lens = @optic(_.land.soil.variables.fluxes.excess_water_soil),
        unit = Unit(; mm = 1, dt = -1),
    ...
    "land_surface__evapotranspiration_volume_flux" => ParameterMetadata(;
        lens = @optic(_.land.soil.variables.fluxes.actual_evapotranspiration),
        unit = Unit(; mm = 1, dt = -1),
    ...
    "land_water_storage__total_depth" => ParameterMetadata(;
        lens = @optic(_.land.variables.total_storage),
        unit = Unit(; mm = 1),
    ...
    "non_compacted_soil_surface_water__excess_volume_flux" => ParameterMetadata(;
        lens = @optic(_.land.soil.variables.fluxes.excess_water_compacted_soil),
        unit = Unit(; mm = 1, dt = -1),
    ...
    "soil_layer_water__volume_percentage" => ParameterMetadata(;
        lens = @optic(_.land.soil.variables.diagnostic.relative_volumetric_water_content),
    ...
    "soil_layer_water_unsaturated_zone__depth" => ParameterMetadata(;
        lens = @optic(_.land.soil.variables.states.unsaturated_layer_depth),
        unit = Unit(; mm = 1),
    ...
    "soil_surface__temperature" => ParameterMetadata(;
        lens = @optic(_.land.soil.variables.states.soil_surface_temperature),
        unit = Unit(; degC = 1, absolute_temperature = true),
    ...
    "soil_surface_water_saturated_zone__exfiltration_volume_flux" =>
        ParameterMetadata(;
            lens = @optic(_.land.soil.variables.fluxes.exfiltration_saturated_water),
            unit = Unit(; mm = 1, dt = -1),
    ...
    "soil_water_root_zone__volume_fraction" => ParameterMetadata(;
        lens = @optic(_.land.soil.variables.diagnostic.volumetric_water_content_root_zone),
        unit = Unit(; m = (3, 3)),
    ...
    "soil_water_root_zone__volume_percentage" => ParameterMetadata(;
        lens = @optic(
            _.land.soil.variables.diagnostic.relative_volumetric_water_content_root_zone
        ),
        unit = Unit(; percentage = 1),
        description = "Volumetric water content in root zone (including residual water content and saturated zone)",
        tags = [:soil_output],
    ...
    "soil_water_saturated_zone__depth" => ParameterMetadata(;
        lens = @optic(_.land.soil.variables.states.saturated_water_depth),
        unit = Unit(; mm = 1),
