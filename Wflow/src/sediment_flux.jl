...
function update_overland_flow!(
    ...
    update_boundary_conditions_sediment_land_transport!(
        model.sediment_flux,
        erosion_model,
    ...
    update_boundary_conditions_sediment_to_river!(model.to_river, model.sediment_flux)
...
function update_river_flow!(
    ...
    update_boundary_conditions_water_level!(
