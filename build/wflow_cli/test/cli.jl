...
@testitem "wflow_sbm_timing" begin
    extension = Sys.iswindows() ? ".exe" : ""
    wflow_exe =
        normpath(@__DIR__, "../../create_binaries/wflow_bundle/bin/wflow_cli" * extension)
    testdir = abspath("../../../Wflow/test")
