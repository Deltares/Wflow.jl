...
| `soil_compacted__area_fraction` | Fraction of the soil that is covered (eg paved, snow, etc) | - | 0.01 |
...
| --- | --- | - |
| `soil_erosion__rainfall_mass_flow_rate` | Total soil erosion from rainfall (splash) | ton Δt⁻¹ |
: {.striped .hover}
...
| Standard Name | Description | Unit |
| --- | --- | - |
| `soil_erosion__overland_flow_mass_flow_rate` | Total soil erosion from overland flow | ton Δt⁻¹ |
: {.striped .hover}
...
| `soil_aggregates_small__mass_fraction` | Soil content small aggregates | - | 0.0 |
| `soil_aggregates_large__mass_fraction` | Soil content large aggregates | - | 0.0 |
: {.striped .hover}
