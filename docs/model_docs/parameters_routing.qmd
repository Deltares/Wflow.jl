...
| `reservoir_water_inflow~external__volume_flow_rate` | External inflow reservoir (negative for abstractions) | m³ s⁻¹ | - |
| `reservoir_water~outgoing~observed__volume_flow_rate` | Observed outflow reservoir | m³ s⁻¹ | - |
: {.striped .hover}
