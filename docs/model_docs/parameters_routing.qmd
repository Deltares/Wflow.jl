...
| Standard Name | Description | Unit | Default |
| ------ | ---- | -- | -- |
| `model_boundary_condition_constant_hydraulic_head` | Head of the boundary | m | - |
: {.striped .hover}
...
| `river_water_aggregates_small__mass` | Small aggregates left in cell | ton |
| `river_water_aggregates_large__mass` | Large aggregates left in cell | ton |
...
| `river_water_aggregates_small__mass_flow_rate` | Sediment flux (small aggregates) | ton Δt⁻¹ |
| `river_water_aggregates_large__mass_flow_rate` | Sediment flux (large aggregates) | ton Δt⁻¹ |
