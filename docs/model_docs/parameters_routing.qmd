...
| `clay_mean_diameter` | Clay mean diameter | μm | 2.0 |
| `silt_mean_diameter` | Silt mean diameter | μm | 10.0 |
| `sand_mean_diameter` | Sand mean diameter | μm | 200.0 |
...
| `river_sediment__median_diameter` | Particle mean diameter | mm | 0.1 |
...
| `clay_mean_diameter` | Clay mean diameter | µm | 2.0 |
| `silt_mean_diameter` | Silt mean diameter | µm | 10.0 |
| `sand_mean_diameter` | Sand mean diameter | µm | 200.0 |
...
| `gravel_mean_diameter` | Gravel mean diameter | µm | 2000.0 |
: {.striped .hover}
