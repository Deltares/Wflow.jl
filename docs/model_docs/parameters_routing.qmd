...
generate_table(Wflow.Routing, :reservoir_generic_input)
```

#### Input
```{julia}
# | code-fold: true
generate_table(Wflow.Routing, :reservoir_input)
```

#### Static or cyclic/forcing input
```{julia}
# | code-fold: true
generate_table(Wflow.Routing, :reservoir_static_cyclic_forcing_input)
```

#### States
```{julia}
# | code-fold: true
generate_table(Wflow.Routing, :reservoir_state)
```

#### Output
```{julia}
# | code-fold: true
generate_table(Wflow.Routing, :reservoir_output)
```
...
```{julia}
# | code-fold: true
generate_table(Wflow.Routing, :kinematic_wave_river_flow_input)
```

#### Static or cyclic/forcing input
```{julia}
# | code-fold: true
generate_table(Wflow.Routing, :kinematic_wave_river_static_cyclic_forcing_input)
```

#### States
```{julia}
# | code-fold: true
generate_table(Wflow.Routing, :kinematic_wave_river_state)
```
