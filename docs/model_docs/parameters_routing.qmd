...
| `lake_water__instantaneous_volume` | Lake volume (instantaneous) | m³ |
...
| `river_water__instantaneous_volume` | River water volume (instantaneous)  | m³ |
...
| `clay__d50_diameter` | Clay mean diameter | μm | 2.0 |
| `silt__d50_diameter` | Silt mean diameter | μm | 10.0 |
| `sand__d50_diameter` | Sand mean diameter | μm | 200.0 |
| `sediment_aggregates~small__d50_diameter` | Small aggregates mean diameter | μm | 30.0 |
| `sediment_aggregates~large__d50_diameter` | Large aggregates mean diameter | μm | 500.0 |
