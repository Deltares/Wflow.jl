...
| `reservoir_water_target_full__volume_fraction` | Target fraction full (of max storage) | - | - |
| `reservoir_water_target_min__volume_fraction` | Target minimum full fraction (of max storage)	| - | - |
...
| `sediment_aggregates_small__mean_diameter` | Small aggregates mean diameter | μm | 30.0 |
| `sediment_aggregates_large__mean_diameter` | Large aggregates mean diameter | μm | 500.0 |
...
| `land_surface_water_aggregates_small__to_river_mass_flow_rate` | Small aggregates flux flowing into the river | ton Δt⁻¹ |
| `land_surface_water_aggregates_large__to_river_mass_flow_rate` | Large aggregates flux flowing into the river | ton Δt⁻¹ |
...
| `sediment_aggregates_small__mean_diameter` | Small aggregates mean diameter | µm | 30.0 |
| `sediment_aggregates_large__mean_diameter` | Large aggregates mean diameter | µm | 500.0 |
...
| `river_bed_aggregates_small__mass` | Small aggregates stored on the river bed after deposition | ton |
| `river_bed_aggregates_large__mass` | Large aggregates stored on the river bed after deposition | ton |
