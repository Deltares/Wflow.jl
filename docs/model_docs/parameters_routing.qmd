...
| --- | --- | - |
| `lake_water_surface__instantaneous_elevation` | Lake water level (internal timestep) | m |
: {.striped .hover}

#### Output
| Standard Name | Description | Unit |
| --- | --- | - |
| `lake_water__volume` | Lake volume (average over timestep) | m³ |
| `lake_water_surface__elevation` | Lake water level (average over timestep) | m |
| `lake_water~outgoing__volume_flow_rate` | Outflow of the lake (average over timestep) | m³ s⁻¹ |
| `lake_water~incoming__volume_flow_rate` | Inflow into the lake (average over timestep) | m³ s⁻¹ |
...
### Reservoirs
#### Generic input {#sec-reservoir-generic-input}
| Standard Name | Description | Unit | Default |
| ------ | ----- | -- | -- |
...
| Standard Name | Description | Unit |
| --- | --- | - |
| `reservoir_water__instantaneous_volume` | Reservoir volume (internal timestep) | m³ |
: {.striped .hover}
...
| `reservoir_water~outgoing__volume_flow_rate` | Outflow of the reservoir (average over the timestep) | m³ s⁻¹ |
| `reservoir_water~incoming__volume_flow_rate` | Inflow into the reservoir (average over the timestep) | m³ s⁻¹ |
...
| Standard Name | Description | Unit |
| --- | --- | - |
| `river_water__instantaneous_volume_flow_rate` | River discharge (internal timesep) | m³ s⁻¹ |
| `river_water__instantaneous_depth` | River water depth (internal timestep) | m |
: {.striped .hover}

#### Output
| Standard Name | Description | Unit |
| --- | --- | - |
| `river_water__volume_flow_rate` | River discharge (average over timestep) | m³ s⁻¹ |
| `river_water__depth` | River water depth (average over timestep) | m |
| `river_water__volume` | River water volume (average over timestep) | m³ |
: {.striped .hover}
...
| Standard Name | Description | Unit |
| --- | --- | - |
| `land_surface_water__instantaneous_volume_flow_rate` | Discharge overland flow (internal timesep) | m³ s⁻¹ |
| `land_surface_water__instantaneous_depth` | Water depth overland flow (internal timestep) | m |
: {.striped .hover}

#### Output
| Standard Name | Description | Unit |
| --- | --- | - |
| `land_surface_water__volume_flow_rate` | Discharge overland flow (average over timestep) | m³ s⁻¹ |
| `land_surface_water__depth` | Water depth overland flow (average over timestep) | m |
| `land_surface_water__volume` | Water volume overland flow (average over timestep) | m³ |
: {.striped .hover}
...
| Standard Name | Description | Unit |
| --- | --- | - |
| `river_water__volume_flow_rate` | River (+ floodplain) discharge (average over timestep) | m³ s⁻¹ |
| `river_water__depth` | River water depth (average over timestep) | m |
| `river_water__volume` | River water volume (average over timestep) | m³ |
: {.striped .hover}
...
| Standard Name | Description | Unit | |
| --- | --- | - |
| `floodplain_water__instantaneous_volume_flow_rate` | Floodplain discharge (internal timestep) | m³ s⁻¹ |
| `floodplain_water__instantaneous_depth` | Floodplain water depth (internal timestep) | m |
: {.striped .hover}

#### Output
| Standard Name | Description | Unit |
| --- | --- | - |
| `floodplain_water__volume` | Floodplain volume (average over timestep) | m³ |
| `floodplain_water__volume_flow_rate` | Floodplain discharge (average over timestep) | m³ s⁻¹ |
: {.striped .hover}
...
| Standard Name | Description | Unit |
| --- | ---- | - |
| `land_surface_water__x_component_of_instantaneous_volume_flow_rate` | Flow in x direction (internal timestep) | m³ s⁻¹ |
| `land_surface_water__y_component_of_instantaneous_volume_flow_rate` | Flow in y direction (internal timestep) | m³ s⁻¹ |
| `land_surface_water__instantaneous_depth` | Water depth (internal timestep) | m |
: {.striped .hover}

#### Output
| Standard Name | Description | Unit |
| --- | --- | - |
| `land_surface_water__depth` | Water depth (average over timestep) | m |
: {.striped .hover}
...
| `land_drain_location__flag` | Drain location | - | - |
: {.striped .hover}
