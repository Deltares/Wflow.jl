...
| `lake__flag` | Include lake modelling | - | `false` |
: {.striped .hover}
...
| `soil_layer__thickness` | Thickness of soil layers | mm | - |
| `topog_sbm_transfer__flag` | Enable original Topog_SBM vertical transfer formulation  | - | `false` |
