...
by the Land Hydrology `SBM` model and net radiation as input. The approach used to estimate
$T_\mathrm{s}$ is based on work by Zink et al. (2018) and Purnamasari et al. (2025).
...
speed and net radiation forcing input are listed
