...
where $\SIb{r_\mathrm{air}}{s\ m^{-1}}$ is aerodynamic conductance, $\SIb{c_\mathrm{p}}{J\
...
height $z$ is set to 2.0 m above the input parameter
`atmosphere_bottom_air__above_ground_height` (land surface "skin" layer height above the
ground).
