...
This module estimates the land surface temperature (LST) $\SIb{T_\mathrm{s}}{\degree C}$
based on evapotranspiration $\SIb{ET}{mm\ t^{-1}}$ simulated by the Land Hydrology `SBM`
model and net radiation as input. The approach used to estimate $T_\mathrm{s}$ is based on
work by Zinc et al. (2018) and Purnamasari et al. (2025).
...
+ Zinc, M., Mai, J., Cuntz, M., and Samaniego, L., 2018, Conditioning a hydrologic model using
