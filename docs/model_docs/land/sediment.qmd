...
$\SIb{\mathrm{KE}}{J\ m^{-2}}$ is the total rainfall kinetic energy, $\SIb{h}{mm}$ is the
surface runoff depth on the soil and $\SIb{\varphi}{mm^{-1}}$ is an exponent varying between
$0.9$ and $3.1$ used to reduce rainfall impact if the soil is already covered by water. As a
