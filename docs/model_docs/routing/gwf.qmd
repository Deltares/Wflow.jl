...
[state variable](../parameters_routing.qmd#state-gwf-unconfined) and [output
variable](../parameters_routing.qmd#output-gwf-unconfined).
...
[input.static]
"model_boundary_condition_constant_hydraulic_head" = "constant_head"
```
