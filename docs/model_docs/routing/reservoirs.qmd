...
reservoir_water_target_full__volume_fraction = "ResTargetFullFrac"
reservoir_water_target_min__volume_fraction = "ResTargetMinFrac"
```
...
by wflow or abstractions can be added to reservoirs, as a cyclic parameter or as part of
...
provided as a cyclic parameter or as part of forcing. For example, cyclic observed outflow
can be provided in the TOML file as follows:
