...
is acceleration due to gravity, $\SIb{\Delta t}{s}$ is the adaptive model time step,
$\SIb{\Delta x}{m}$ is the distance between two cells and $\SIb{\Delta y}{m}$ is the flow
width. Below the staggered grid and variables of the numerical solution in the x-direction,
based on Almeida et al. (2012):
