...
as a static or cyclic parameter or as part of forcing. For example, cyclic inflow can be
provided in the TOML file as follows:
...
inertial model. Abstractions are limited to a maximum of $\SI{80}{\%}$ of the river storage.
Negative external inflows are satisfied first, and the remaining river storage is available
for internal abstractions as part of water demand and allocation computations.
