...
Courant number or a fixed time step size $\SIb{}{d}$. To enable a fixed internal time step
...
subsurface_kinematic_wave__time_step = 0.5 # optional, default is 1.0 day
```
