...
vertical [SBM](../land/landhydrology_sbm.qmd#soil-processes) concept, and these profiles
(after unit conversion) are also used to compute lateral subsurface flow. The following
profiles (see [SBM](../land/landhydrology_sbm.qmd#soil-processes) for a detailed
