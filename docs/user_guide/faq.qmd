...
It is also possible to run the model without 1D floodplains. This means that the model is
using kinematic wave for land routing and either kinematic wave or local inertial for river
routing. This can lead to unrealistically large water depths when the bankfull capacity is
exceeded as there is no exchange of water between the river channel and floodplains.
