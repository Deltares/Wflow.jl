...
reservoir_water_surface__initial_elevation = "reservoir_waterlevel"
...
### 1D floodplains on a staggered grid

```toml
[model]
river_routing = "local_inertial"    # one of ("local_inertial" or "manning_staggered")
...
### 1D floodplains (kinematic wave routing)
...
[state.variables]
floodplain_water__volume = "storage_floodplain"
```

### 2D floodplains (local inertial routing)
