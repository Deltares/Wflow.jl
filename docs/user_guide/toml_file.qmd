...
from Delft-FEWS](fews.qmd), the `fews_run` setting needs to be set at `true`.
...
cold_start = true                       # cold (cold_start = true) or warm state (cold_start = false), default is true
reservoirs = true                       # include reservoir modelling, default is false
kinematic_wave_adaptive_tstep = true    # enable kinematic wave adaptive (internal) timestepping in the model, default is false
soil_thickness_layer = [100, 300, 800]  # specific SBM soil model setting: for each soil layer, a thickness [mm] is specified
