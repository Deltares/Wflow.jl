...
model (see [here](@ref wflow_sbm_data)). Example data for the other model configurations can be
...
TOML settings file. See the section on [example models](@ref sample_data) on how to use this
functionality.
...
two-dimensional map with values at each grid cell. Only values within the basin are required.
