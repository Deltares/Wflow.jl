...
---- | --- | -- | -
`local_drain_direction` | Flow direction (1-9) | `wflow_ldd` | -
`river_location__mask` | Map indicating the river cells (0-1) | `wflow_river` | -
`river__length` | The length of the river | `wflow_riverlength` | m
`river__width ` | The width of the river | `wflow_riverwidth` | m
`subcatchment_location__count` | Mask of the basin | `wflow_subcatch` | -
