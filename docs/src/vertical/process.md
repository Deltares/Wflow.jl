...
## Snow and glaciers
Snow and glacier processes are derived from the original HBV concept and HBV-light
respectively. 
...
can be determined through a lookup table with land cover based on literature (Pitman 1986,
