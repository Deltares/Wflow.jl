...
the latest changes manually using `git pull`.
...
::: {.callout-note}
The old version of wflow, based on Python and PCRaster libraries is also available to download
from our website [download.deltares.nl](https://download.deltares.nl/en/download/wflow/). We
recommend installing the Julia version, as the Python version is End-of-Life and will not be supported
anymore. Note also that this documentation is also written and meant to support the Julia
version.
:::
