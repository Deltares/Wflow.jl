...
nodes, that should be provided in CSV format, see also [Storage and rating curves from
...
1. The kinematic wave approach (see section [Subsurface flow
   ...
   `subsurface_water__horizontal_to_vertical_saturated_hydraulic_conductivity_ratio` [-] is
