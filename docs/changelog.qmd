...
### Fixed
- Fixed a bug in EUROSEM rainfall erosion calculation where the exponent was incorrectly
  specified in units of mm⁻¹ instead of m⁻¹, causing the protective effect of water depth
  to be overestimated by a factor of 1000. This significantly changes EUROSEM rainfall
  erosion results.
