...
### Fixed
- Introduced in v1.0.0-rc2, setting fixed values for forcing parameters failed for model
  type `sediment` because of incorrect handling of reservoirs, this has been fixed.

### Changed

### Added

## v1.0.0-rc2 - 2025-09-29
