...
- Water depth for waterbody locations (boundary condition) of the local inertial model for
  river and land routing was computed and should remain zero during the simulation.
